...
public class Alquiler {
    ...
    public Alquiler(String nombreCliente, int documentoCliente, LocalDate fechaAlquiler, LocalDate fechaDevolucion,
            int posicionAmarre, double valorAlquiler, Barco barcoAlquilado) {
